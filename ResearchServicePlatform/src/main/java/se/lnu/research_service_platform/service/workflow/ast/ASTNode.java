...
import se.lnu.research_service_platform.taskgraph.TaskGraph.CALL;
import se.lnu.research_service_platform.taskgraph.TaskGraph.EAssignOp;
import se.lnu.research_service_platform.taskgraph.TaskGraph.EBinaryOp;
import se.lnu.research_service_platform.taskgraph.TaskGraph.EUnaryOp;
import se.lnu.research_service_platform.taskgraph.TaskGraph.IF;
import se.lnu.research_service_platform.taskgraph.TaskGraph.LIST_END;
import se.lnu.research_service_platform.taskgraph.TaskGraph.LIST_ITEM;
import se.lnu.research_service_platform.taskgraph.TaskGraph.LIST_START;
import se.lnu.research_service_platform.taskgraph.TaskGraph.Load;
import se.lnu.research_service_platform.taskgraph.TaskGraph.PARALLEL;
import se.lnu.research_service_platform.taskgraph.TaskGraph.PARAM;
import se.lnu.research_service_platform.taskgraph.TaskGraph.QUALIFIED_ACCESS;
import se.lnu.research_service_platform.taskgraph.TaskGraph.RETURN;
import se.lnu.research_service_platform.taskgraph.TaskGraph.Store;
...
public abstract class ASTNode extends CommonTree {
    ...
    public static class BooleanLiteral extends Expression {
        ...
        public TaskGraph getFirst() {
            ...
            TaskGraph.BooleanLiteral literal = new TaskGraph.BooleanLiteral();
    ...
    public static class IntegerLiteral extends Expression {
        ...
        public TaskGraph getFirst() {
            ...
            TaskGraph.IntLiteral literal = new TaskGraph.IntLiteral();
            literal.setValue(value);
    ...
    public static class NullLiteral extends Expression {
        ...
        public TaskGraph getFirst() {
            ...
            TaskGraph.Literal literal = new TaskGraph.Literal();
            literal.setValue(value);
